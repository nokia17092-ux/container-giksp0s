...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-giksp0s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-giksp0s.containers.anotherwebservice.com/
...
```
git clone git@github.com:nokia17092-ux/container-giksp0s.git
cd container-giksp0s
```
...
```
docker attach container-giksp0s
```
